DROP SEQUENCE  IF EXISTS  seq_serv;
...
CREATE SEQUENCE  IF NOT EXISTS  seq_emp  INCREMENT  BY 1
...
CREATE SEQUENCE  IF NOT EXISTS  seq_serv  INCREMENT  BY 1
    
    START  WITH 20 
    OWNED BY serv.noserv;
